...
@SourceType(value = "D365SalesARP", label = "D365Sales",uiConfig = "d365sales-layout.json")
public class D365SalesConf extends AbstractArpConf<D365SalesConf> {
  private static final String ARP_FILENAME = "arp/implementation/d365sales-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.d365sales.D365SalesDriver";
